...
public data class CourseFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): CourseFragmentArgs {
      bundle.setClassLoader(CourseFragmentArgs::class.java.classLoader)
      val __course : Course?
      ...
      return CourseFragmentArgs(__course, __user)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): CourseFragmentArgs {
      val __course : Course?
