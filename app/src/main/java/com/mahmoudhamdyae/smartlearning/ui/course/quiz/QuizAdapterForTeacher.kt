...
import com.mahmoudhamdyae.smartlearning.databinding.QuizItemForTeacherBinding

class QuizAdapterForTeacher(private val onClickListener: OnClickListener) :
    ListAdapter<Quiz, QuizAdapterForTeacher.QuizzesPropertyViewHolder>(DiffCallback) {
     ...
     */
    class QuizzesPropertyViewHolder(private var binding: QuizItemForTeacherBinding):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuizzesPropertyViewHolder {
        return QuizzesPropertyViewHolder(
            QuizItemForTeacherBinding.inflate(
                LayoutInflater.from(
                    parent.context
                )
            )
